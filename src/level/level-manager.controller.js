export default class LevelManager {
    ...
    collisionDetection(playerSprite, wallSprite) {
        ...
        return playerBox.x + playerBox.width > wallBox.x &&
    ...
    intersects(circle, rect) {
        ...
        let cornerDistance_sq = (circleDistanceX - rect.width / radiusDivider) ^ 2 +
            (circleDistanceY - rect.height / radiusDivider) ^ 2;
